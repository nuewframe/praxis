...
| [`INIT.ast-onboarding-and-guardrails`](product/initiatives/INIT.ast-onboarding-and-guardrails.md) | Dedicated AST onboarding skill, mandatory agent instructions, and anti-meta-commentary guardrails (`v0.7.1`). | ⚪ Proposed | 5 — 0 ✅ |
