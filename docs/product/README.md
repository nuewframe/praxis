...
| [wave-executable-seams](waves/wave-executable-seams/README.md) | Build against a frozen promise instead of waiting for a merge. | ✅ Delivered† | 5 — 5 ✅ |
...
| [wave-brownfield-adoption](waves/wave-brownfield-adoption/README.md) | A product that already ships can adopt the method against what it has. | ✅ Delivered | 2 — 2 ✅ |
